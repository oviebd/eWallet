...
class RecordDataUtility {
   ...
   // var reecordList: [RecordData] = [RecordData]()
    ...
    func prepareList() -> [RecordData] {
        ...
        let list1 = RecordData(id: "1", catagory: "Food & Drinks", accountName: "pocket money", shortDescription: "Fruits and other costs", amount: "-BDT 500.00", date: "Mar 14", image: "fossil.shell.fill", color: .red)
